...
class Util(object):
    ...
    @staticmethod
    def run_experiment(com, enc, data, N=100, verbose=True):
        ...
        *args / **kwargs = settings for the compression method, e.g. `9`
        ...
        for n in range(N):
            ...
            compressed_data, t2 = Util.compress(com, encoded_data)
    ...
    @staticmethod
    def run_variable_experiment(com, enc, data, steps, N=100, verbose=True):
        '''Benchmark one compression method
        com = [BROTLI, BZ2, LZMA, LZO, ZLIB, ZSTD]
        data = data set
        N = number of runs
    ...
    def plot_all(
        ...
        compresso_font = font_base
        compresso_font.set_size(15)
        xticks_fonts = [compresso_font] * len(compresso)
